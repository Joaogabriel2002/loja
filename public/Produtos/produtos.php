        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
                ...
                <div class="flex flex-col gap-3">
                    <a href="CadastrarProdutos.php" class="w-full text-center bg-blue-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-blue-700 transition">
                        <i class="fas fa-plus mr-2"></i>Cadastrar Novo
                    </a>
                    <a href="ListarProdutos.php" class="w-full text-center bg-gray-200 text-gray-800 font-semibold py-3 px-4 rounded-lg hover:bg-gray-300 transition">
